...
button.addEventListener("click", (event) => {
    ...
    if (keysCount !== questions.length) {
        ...
        const res = confirm('Hey, you are a ' + keyMaps[maxKey] + ' learner!. Click to proceed to the content page.');

        if (res) {
            if (maxKey === "K") window.location.href = "../Kinesthetic/kinesthetic.html";
            if (maxKey === "A") window.location.href = "../Aural/aural.html";
            if (maxKey === "V") window.location.href = "../Visual/visual.html";
            if (maxKey === "R") window.location.href = "../Read/read.html";
        }
        // saveToFirebase(data);
    }
});
